...
public class ProductServlet extends HttpServlet {
    ...
    private void createProduct(HttpServletRequest request, HttpServletResponse response) 
        ...
        try {
            ...
            } else if (productDAO.isProductIdExists(productId)) {
            ...
            Product product = new Product(productId, productName, categoryId, unitId,
                                        importPrice, sellingPrice, description, status,
                                        imageUrl, createdBy);
