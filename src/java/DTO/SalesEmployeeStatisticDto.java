...
public class SalesEmployeeStatisticDto {
    ...
    public SalesEmployeeStatisticDto(int employeeID, String fullName, BigDecimal totalRevenue, int totalOrders, int totalProductsSold, BigDecimal averageRevenuePerOrder) {
