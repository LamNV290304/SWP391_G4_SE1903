                                ...
                                <div class="card-body">
                                    <form action="ReportItemServlet" method="get">
                                        <div class="row g-3 align-items-center">
                                            ...
                                            <div class="col-md-4">
                                                <label for="totalValueDisplay" class="form-label d-block mb-1">Tổng giá trị đồ dùng cửa hàng:</label>
                                                <span id="totalValueDisplay" class="badge bg-label-success fs-5">
                                                    <c:choose>
                                                        <c:when test="${not empty selectedShopTotalValue}">
                                                            <fmt:formatNumber value="${selectedShopTotalValue}" type="currency" currencySymbol="VNĐ" maxFractionDigits="0"/>
                                                        </c:when>
                                                        <c:otherwise>
                                                            0 VNĐ
                                                        </c:otherwise>
                                                                            ...
                                                                            callbacks: {
                                                                                label: function (context) {
                                                                                    ...
                                                                                    if (context.parsed !== null) {
                                                                                        ...
                                                                                        const percentage = totalSumShopValues > 0 ? ((value / totalSumShopValues) * 100).toFixed(2) : 0;
                                                                                        label += new Intl.NumberFormat('vi-VN', {style: 'currency', currency: 'VND', maximumFractionDigits: 0}).format(value) + ' (' + percentage + '%)';
                                                                                    }
                                                                                    return label;
                                                                                }
                                                                            }
