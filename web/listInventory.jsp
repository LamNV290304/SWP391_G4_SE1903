                        ...
                        <div class="container-xxl flex-grow-1 container-p-y">
                            ...
                            <div class="card">
                                ...
                                <div class="table-responsive text-nowrap">
                                    <form method="GET" action="listInventoryHome" class="row g-3 px-4 py-3">
                                        <div class="col-md-2">
                                        ...
                                        <div class="col-md-2">
                                            <select name="shopID" class="form-select">
                                                ...
                                                <c:forEach var="s" items="${shopList}">
                                                    <option value="${s.shopID}" ${param.shopID == s.shopID ? "selected" : ""}>
                                                        ${s.shopName}
                                                    </option>
                                                </c:forEach>
                                            </select>
                                        ...
                                        <div class="col-md-2">
                                            <input type="number" name="minQuantity" class="form-control" placeholder="Số lượng tối thiểu" value="${param.minQuantity}">
                                        </div>
                                        <div class="col-md-2">
                                            <input type="number" name="maxQuantity" class="form-control" placeholder="Số lượng tối đa" value="${param.maxQuantity}">
                                        </div>
                                        <div class="col-md-2">
