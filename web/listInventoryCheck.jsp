                    ...
                    <div class="container" style="padding-top: 20px;"> 
                        ...
                        <div class="card col-sm-12" style="height: 90vh; overflow: hidden;">
                            ...
                            <div class="table-responsive text-nowrap" style="height: calc(80vh - 80px); overflow-y: auto;">
                                <form method="GET" action="InventoryCheckServlet" class="row p-3">
                                    <div class="col-md-2">
                                        <select class="form-select form-select-sm" name="shopID">
                                            <option value="">-- Kho kiểm kê --</option>
                                    ...
                                    <div class="col-md-2">
                                        <select class="form-select form-select-sm" name="employeeID">
                                            ...
                                            <c:forEach var="e" items="${listEmp}">
                                                <option value="${e.id}" ${e.id == employeeID ? "selected" : ""}>${e.fullName}</option>
                                            </c:forEach>
                                        </select>
                                    </div>
                                    <div class="col-md-2">
                                    ...
                                    <div class="col-md-2">
                                        ...
                                        <a href="InventoryCheckServlet" class="btn btn-secondary btn-sm">Reset</a>
                                    </div>
                                </form>
