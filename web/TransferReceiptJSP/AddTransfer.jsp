    ...
    <body>
        ...
        <form action="TransferReceipt" method="POST">
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="card mb-4">
                        <h5 class="card-header">Select your Product</h5>
                        <div class="card-body">
                            <div class="mb-3">
                                ...
                                <select name="ProductID" class="form-select" id="ProductID">
                                    ...
                                    <c:forEach var="c" items="${vectorP}">
                                        <option value="${c.productID}" 
                                                <c:if test="${selectProduct == c.productID}">selected</c:if>>
                                            ${c.productName}
                                        </option>
                                    </c:forEach>
                                </select>
                                ...
                                <input type="submit" name="submitP" value="selectP" />
                ...
                <!-- RIGHT SIDE: ADD NEW TRANSFER -->
                <c:if test="${not empty selectProduct}">
                    <div class="col-md-6">
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select name="FromInventoryID" class="form-select" onchange="this.form.submit()">
                                        <option selected>Select from Shop</option>
                                        <c:forEach var="c" items="${vectorI}">
                                            <option value="${c.inventoryID}" <c:if test="${c.inventoryID == selectedFromID}">selected</c:if>>
                                                ${c.shop.shopName}
                                            </option>
                                        </c:forEach>
                                    </select>
                                ...
                                <div class="mb-3">
                                    ...
                                    <select name="ToInventoryID" class="form-select">
                                        ...
                                        <c:forEach var="c" items="${vectorI}">
                                            <c:if test="${c.inventoryID != selectedFromID}">
                                                <option value="${c.inventoryID}">${c.shop.shopName}</option>
                                            </c:if>
                                        </c:forEach>
                                    </select>
                                </div>
                                ...
                                <div>
                                    <input type="submit" name="submit" value="Add Transfer" class="btn btn-primary">
                                </div>
