...
<html lang="en"
    ...
    <head>
        ...
        <title>Chỉnh sửa Đồ dùng Cửa hàng - Sneat</title>
                ...
                <div class="layout-page">
                    ...
                    <div class="content-wrapper">
                        <div class="container-xxl flex-grow-1 container-p-y">
                            ...
                            <%-- Form Chỉnh sửa --%>
                            <div class="card mb-4">
                                <h5 class="card-header">Chỉnh sửa Đồ dùng: ${itemToEdit.itemName}</h5>
                                <div class="card-body">
                                    <form action="ShopItemServlet" method="post">
                                        ...
                                        <div class="row justify-content-end">
                                            <div class="col-sm-10">
                                                <button type="submit" class="btn btn-primary me-2">Cập nhật Đồ dùng</button>
